...
> **Kurtarma notu (2026-08-14):** Bu belge 3234258 ("bayat snapshot
> temizliği") içinde silindi, ancak issue #110 (JIT Dilim 5 try/catch)
> hâlâ §7/§7.1/§8/§10/§11'e dayanıyor — o yüzden içeriği değiştirilmeden
> `3234258^`'ten docs/ altına geri alındı. Gövde aşağıda olduğu gibidir;
> Dilim 0-4'ün önemli bölümü bu tarihten sonra uygulanmıştır (shadow stack,
> host çağrı köprüsü, nullable ABI — güncel uygulama için kaynak kod
> bağlayıcıdır, bu belge tasarım gerekçesidir).
