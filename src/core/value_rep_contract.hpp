...
inline constexpr ValueRepRow kValueRepTable[] = {
    ...
    {"Float",
     "Value::floatValue() — skaler unyon üyesi (double)",
     "MIR_T_D (64-bit double)",
     "uyumlu",
     "ostringstream << floatValue",
     "—"},
    {"Float32",
     "Value::floatValue() — skaler unyon; (float) truncate",
    ...
    {"Date",
     "Value::int64Value() — skaler unyon; UTC epoch-ms",
    ...
    {"Decimal",
     "Value::decimalValue() — unyon üyesi (ADR-028)",
